...
<x-layouts.public :meta="$meta ?? []">
    <section class="py-24 md:py-32 px-4 relative overflow-hidden pt-36">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            <h1 class="text-white font-heading text-4xl sm:text-5xl md:text-7xl lg:text-8xl tracking-tighter uppercase mb-6 leading-[1.1]">Blog</h1>
            <p class="text-white/40 text-lg md:text-xl font-medium max-w-2xl leading-relaxed">{{ $isEs ? 'Consejos de fitness, salud y bienestar del equipo A1.' : 'Fitness, health, and wellness tips from the A1 team.' }}</p>
        </div>
    </section>
