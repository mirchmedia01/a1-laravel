...
<x-layouts.public :meta="$meta ?? []">
    ...
    @php
        $cat = $blog['category'] ?? '';
        $ctaMap = [
            'Strength' => ['slug' => 'personal-training', 'text' => $isEs ? 'Entrena con nuestros expertos' : 'Train with our strength experts', 'es' => 'Entrena con nuestros expertos en fuerza', 'en' => 'Train with our strength experts'],
            'Nutrition' => ['slug' => 'registered-dietitians', 'text' => $isEs ? 'Habla con un dietista' : 'Speak with a registered dietitian', 'es' => 'Habla con un dietista registrado', 'en' => 'Speak with a registered dietitian'],
            'Recovery' => ['slug' => 'physical-therapy', 'text' => $isEs ? 'Programa una consulta de terapia física' : 'Book a physical therapy consult', 'es' => 'Programa una consulta de terapia física', 'en' => 'Book a physical therapy consult'],
            'Training' => ['slug' => 'personal-training', 'text' => $isEs ? 'Comienza tu entrenamiento' : 'Start your training journey', 'es' => 'Comienza tu entrenamiento', 'en' => 'Start your training journey'],
            'Mindset' => ['slug' => 'consultations', 'text' => $isEs ? 'Reserva una consulta gratuita' : 'Book a free consultation', 'es' => 'Reserva una consulta gratuita', 'en' => 'Book a free consultation'],
            'Lifestyle' => ['slug' => 'consultations', 'text' => $isEs ? 'Transforma tu estilo de vida' : 'Transform your lifestyle', 'es' => 'Transforma tu estilo de vida', 'en' => 'Transform your lifestyle'],
        ];
        $cta = $ctaMap[$cat] ?? ['slug' => 'consultations', 'text' => $isEs ? 'Comienza tu viaje' : 'Start your journey', 'en' => 'Start your journey', 'es' => 'Comienza tu viaje'];
    @endphp
    <section class="px-4 pb-8">
        <div class="max-w-3xl mx-auto bg-accent/10 border border-accent/20 rounded-[30px] p-8 text-center">
            <p class="text-white font-heading text-xl font-black uppercase mb-4">{{ $isEs ? '¿Listo para actuar?' : 'Ready to take action?' }}</p>
    ...
    <section class="px-4 pb-24">
        <div class="max-w-7xl mx-auto">
            <h2 class="text-white font-heading text-3xl md:text-4xl uppercase tracking-tighter mb-8 text-center">{{ $isEs ? 'Artículos Relacionados' : 'Related Articles' }}</h2>
