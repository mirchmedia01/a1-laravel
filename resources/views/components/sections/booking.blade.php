...
<section class="bg-lightGray py-16 md:py-24 px-4 md:px-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-gray-200 p-8 md:p-12 rounded-[30px] text-center shadow-sm group hover:-translate-y-2 hover:border-accent/40 hover:shadow-lg transition-all duration-500">
                ...
                <h3 class="text-asphaltBlack font-heading text-2xl font-black uppercase mb-2">{{ $isEs ? 'Visita' : 'Visit' }}</h3>
                <p class="text-gray-500 text-sm">{{ $isEs ? 'Conoce nuestro estudio' : 'Meet us at the studio' }}</p>
            ...
            <div class="bg-white border border-gray-200 p-8 md:p-12 rounded-[30px] text-center shadow-sm group hover:-translate-y-2 hover:border-accent/40 hover:shadow-lg transition-all duration-500">
                ...
                <h3 class="text-asphaltBlack font-heading text-2xl font-black uppercase mb-2">{{ $isEs ? 'Email' : 'Email' }}</h3>
                <p class="text-gray-500 text-sm">{{ $isEs ? 'Envíanos un mensaje' : 'Send us a message' }}</p>
