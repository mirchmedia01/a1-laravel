...
<section class="py-16 md:py-20 px-4 md:px-6 border-t border-white/5 overflow-hidden">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="flex whitespace-nowrap animate-marquee gap-12 md:gap-16">
            <div class="flex gap-12 md:gap-16 opacity-30 shrink-0">
